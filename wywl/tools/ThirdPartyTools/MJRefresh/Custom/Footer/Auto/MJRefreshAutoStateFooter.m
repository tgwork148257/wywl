...
- (void)placeSubviews
{
    ...
    // 自定义loading图
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(134 * SCALE_X, 0, 40, 40)];
    ...
    self.stateLabel.frame = CGRectMake(imageView.frame.origin.x + imageView.frame.size.width, self.stateLabel.frame.origin.y, self.stateLabel.frame.size.width, self.stateLabel.frame.size.height);
